...
CREATE TABLE SALE (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY NOT NULL, DATE DATE, TOTAL DOUBLE, STATUS CHAR(1), CUSTOMER_VAT INTEGER REFERENCES CUSTOMER(VATNUMBER) ON DELETE CASCADE ON UPDATE CASCADE)
